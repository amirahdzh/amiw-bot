...
async function execute(interaction) {
    ...
    const publicMsg = `**<@${member.id}>, jangan lupa cek DM ya!**\n\n` +
    ...
    member.send(`✨ **Hai <@${member.id}>!** ✨\n\n` +
        ...
        `> *Kalau mau akses akun utama amiw, DM langsung ke<@454985541327519744> aja yaa. Buat kamu pasti boleh kok! :3*`).catch(() => { });
}
